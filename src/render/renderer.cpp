...
#define SET_TRANSFORM(z, n, function) template void function<n>(const Transformation<n>&);
BOOST_PP_REPEAT_FROM_TO(1, 4, SET_TRANSFORM, Renderer::set_transform)

// no need for templates for glm::mat4 (generated by instantiation above for set_transform<glm::mat4>())
#define SET_UNIFORM_ARR(z, n, function) template void function(const std::string&, const std::array<glm::vec3, n>&);
BOOST_PP_REPEAT_FROM_TO(2, 4, SET_UNIFORM_ARR, Renderer::set_uniform_arr)
